...
class DevCtrl2(QWidget):
    def __init__(self, diseaseName, tempDiseaseInfo):
        ...
        grid.addWidget(self.button, 1, 1, 2, 2)
        ...
        if("진료과" in selectedDiseaseInfo):
            ...
            grid.addWidget(self.btn, 3, 1, 1, 2)
        ...
        self.btn.clicked.connect(self.btn_clicked)
        #grid.addWidget(self.btn, 1, 12, 1, 1)
        ...
        grid.addWidget(self.label, 1, 3, 1, 8)
        ...
        for i in range(1,len(keys)):
            if(keys[i] in tempDiseaseInfo):
                ...
                grid.addWidget(self.label, 1+i, 3, 1, 9)
